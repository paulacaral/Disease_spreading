...
//------------------ MAIN DE EJEMPLO PARA VISUALIZAR CON VMD ------------------//
	...
	//----------------------------------------------------------------------------------------------//
		...
		Visual_Frame0(p_j, N_I, N_R, N_S, x_I, x_R, x_S);
		...
		{	
			...
			if(runs == 0) Visual_Frames(p_j, N_I, N_R, N_S, x_I, x_R, x_S, l);
	...
	sprintf(filename_Nmean, "C:\\Users\\Paula\\Documents\\Facultad\\Fisica Computacional\\Final\\Codigo\\P %.2f\\N_I_mean_%.2f.txt",p_j,p_j);
